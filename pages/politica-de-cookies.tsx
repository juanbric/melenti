  ...
  return (
    <div className="py-4 lg:py-6">
      ...
      <ul className="copy">
        ...
        <li>
          {"\u2022  "}
          Al utilizar Melenti, acepta nuestro uso de cookies de acuerdo con esta
          política.
        </li>
        <br />
        <li>
        ...
        <li>
          ...
          es posible que algunas partes de Melenti no funcionen correctamente.
        </li>
        <br />
        <li>
          {"\u2022 "}
          Melenti se reserva el derecho a modificar esta política de cookies en
