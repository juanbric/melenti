  ...
  return (
    <div className="py-4 lg:py-6">
      ...
      <ul className="copy azul">
        ...
        <li>
          {"\u2022  "}
          El contenido de Melenti es solo para fines informativos y no debe
        ...
        <li>
          {"\u2022 "}
          Melenti no se hace responsable por la exactitud, integridad o
          actualidad del contenido del blog.
        </li>
        <br />
        <li>
          {"\u2022 "}
          No está permitido utilizar el contenido de Melenti sin permiso previo
          y debidamente acreditado.
        </li>
        <br />
        <li>
          {"\u2022 "}
          Melenti se reserva el derecho a cambiar, actualizar o eliminar
          cualquier contenido del blog sin previo aviso.
        </li>
        <br />
        <li>
          {"\u2022  "}
          Al utilizar Melenti, acepta cumplir con todas las leyes y regulaciones
          aplicables.
        </li>
        <br />
        <li>
          {"\u2022  "}
          Melenti se reserva el derecho a modificar estos términos y condiciones
